...
?>
   ...
   <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Liste des citoyens gondwaniens</h4>
                </div>
                  <div class="col-md-12">
                        ...
                        <table class="table  table-bordered table-striped table-condensed" id="mytable">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td> <?php echo $datenaiss.' à '.$lieunaiss;  ?></td>
                                <td> <?php echo $cni; ?></td>
                                <td> <?php echo $sexe;?></td>
                                ...
                                <td> <a href='generer.php?id=<?php echo $id; ?>'> <span class="glyphicon glyphicon-file"> Générer </span> </a> </td>
  ...
  <?php
       ...
       echo "<script langage='javascript'> alert(\"La base de données est vide. Veuillez insérer pour pouvoir lister!\")</script>";
